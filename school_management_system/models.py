...
class School(models.Model):
    ...
    website = models.URLField(help_text='Link to the website')
...
class Student(models.Model):
    ...
    school = models.ForeignKey(School, related_name='school_id', on_delete=models.CASCADE, null=False, blank=False)
